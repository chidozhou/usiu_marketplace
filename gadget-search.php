...
<section class="food-search text-center">
    <div class="container">
        ...
        <h2>Gadgets on Your Search <a href="#" class="text-white">"<?php echo $search; ?>"</a></h2>
...
<section class="food-menu">
    <div class="container">
        ...
        <?php 
            ...
            //SQL Query to Get gadgets based on search keyword
            //$search = burger '; DROP database name;
            // "SELECT * FROM tbl_gadget WHERE title LIKE '%burger'%' OR description LIKE '%burger%'";
            $sql = "SELECT * FROM tbl_gadget WHERE title LIKE '%$search%' OR description LIKE '%$search%'";
            ...
            //Check whether gadget available of not
            if($count>0)
            {
                //gadget Available
