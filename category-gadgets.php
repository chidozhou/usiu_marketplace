...
<section class="food-search text-center">
    <div class="container">
        ...
        <h2>gadgets on <a href="#" class="text-white">"<?php echo $category_title; ?>"</a></h2>
...
<section class="food-menu">
    <div class="container">
        ...
        <?php 
            ...
            //Create SQL Query to Get gadgets based on Selected CAtegory
            $sql2 = "SELECT * FROM tbl_gadget WHERE category_id=$category_id";
            ...
            //CHeck whether gadget is available or not
            if($count2>0)
            {
                //gadget is Available
